...
import com.science.com.em.widget.OnWheelChangedListener;
import com.science.com.em.widget.OnWheelScrollListener;
import com.science.com.em.widget.WheelView;
import com.science.com.em.widget.adapters.AbstractWheelTextAdapter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.long_term_tv://选择长期时间监听
                if (!mBlnBeLongTerm) {
                    mLongTermTextView.setBackgroundResource(R.mipmap.ic_launcher);
                    mBlnBeLongTerm = true;
                } else {
                    mLongTermTextView.setBackgroundResource(R.mipmap.ic_launcher);
