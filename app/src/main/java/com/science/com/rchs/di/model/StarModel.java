...
public class StarModel implements StarContract.StarModel {


    @Override
    public void reponseStarData(String token, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiServiceHeader(Contant.Re,token,ApiService.class)
                .getStarContent(token)
