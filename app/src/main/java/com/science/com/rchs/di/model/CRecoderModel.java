...
public class CRecoderModel implements CRecoderContract.CRecoderModel {

    @Override
    public void reponseCRecoderData(String token, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiService(Contant.Re, ApiService.class)
                .getCRecoderContent(token)
