...
public class OrderShaiModel implements OrderShaiContract.OrderShaiModel {


    @Override
    public void reponseOrderShaiData(String token, String type, int startTime, int endTime, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiServiceHeader(Contant.Re,token,ApiService.class)
                .getOrderShaiContent(token,type,startTime,endTime)
