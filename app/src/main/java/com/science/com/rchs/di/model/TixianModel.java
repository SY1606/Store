...
public class TixianModel implements TixianContract.TixianModel {

    @Override
    public void reponseTixianData(String token, String mchId, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiServiceHeader(Contant.Re,token,ApiService.class)
                .getTixainContent(token,mchId)
