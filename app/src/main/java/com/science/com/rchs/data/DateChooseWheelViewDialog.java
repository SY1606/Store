package com.science.com.rchs.data;
...
import com.science.com.rchs.data.widget.OnWheelChangedListener;
import com.science.com.rchs.data.widget.OnWheelScrollListener;
import com.science.com.rchs.data.widget.WheelView;
import com.science.com.rchs.data.widget.adapters.AbstractWheelTextAdapter;
...
public class DateChooseWheelViewDialog extends Dialog implements View.OnClickListener {
    ...
    public DateChooseWheelViewDialog(Context context, DateChooseInterface dateChooseInterface) {
        ...
        mDialog = new Dialog(context,R.style.dialog_lhp);
        initView();
        initData();
    }
