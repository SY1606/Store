...
public class DalistListModel implements DalisListContract.DalisListModel {


    @Override
    public void reponseDalisListData(String token, int startTime, int endTime, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiServiceHeader(Contant.Re,token,ApiService.class)
                .getDalistListContent(token,startTime,endTime)
