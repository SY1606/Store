...
import com.science.com.rchs.di.presenter.OrderShaiPresenter;
...
public class Frag_s_pay extends Fragment implements OrderShaiContract.OrderShaiView, OnDateSetListener {
    ...
    @BindView(R.id.all)
    TextView all;
    private OrderShaiContract.OrderShaiPresenter orderShaiPresenter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_s_pay, container, false);
        orderShaiPresenter = new OrderShaiPresenter();
        orderShaiPresenter.attachView(this);
    ...
    @OnClick({R.id.start_time, R.id.end_time, R.id.chooes, R.id.mlogin})
        ...
        switch (view.getId()) {
            case R.id.mlogin:
                if (startTime > endTime) {
                    ...
                    orderShaiPresenter.requestOrderShaiData(token, type, startTime, endTime);
                    getActivity().finish();
                }
