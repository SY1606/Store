...
public class Frag_s_tui extends Fragment implements OnDateSetListener, WinContract.WinView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.frag_s_tui, container, false);
