...
public class XiaofeiModel implements XiaofeiContract.XiaofeiModel {

    @Override
    public void reponseXiaofeiData(String token, String card_number, String value, String remark, final CallBack callBack) {
        RetrofitUtils.getRetrofitUtils().getApiServiceHeader(Contant.Re,token,ApiService.class)
                .getXiaofeiContent(token,card_number,value,remark)
