...
public class WinModel implements WinContract.WinModel {

    @Override
    public void reponseWinData(String token, String type, int startTime, int endTime, final CallBack callBack) {
